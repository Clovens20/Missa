      ...
      <div className="bg-gray-900 text-white py-2">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between text-xs">
          <div className="flex items-center gap-4 hidden md:flex">
            <div className="flex items-center gap-1.5"><Truck className="w-3.5 h-3.5 text-secondary"/><span>🚚 Livraison gratuite</span></div>
          ...
          <div className="md:hidden text-center w-full text-[10px] sm:text-xs px-2 truncate sm:whitespace-normal">🚚 Livraison gratuite partout | 🔒 Paiement sécurisé</div>
